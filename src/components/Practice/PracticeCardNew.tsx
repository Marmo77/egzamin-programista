...
const PracticeCard = memo(({ exam }: { exam: PracticeType }) => {
  ...
  const languages = exam.languages.map((tech) => {
    ...
    return (
      <Badge
        key={tech}
        className={`${style.text} ${style.border} bg-transparent py-1 px-2.5 rounded-xl flex items-center gap-1 uppercase dark:bg-primary dark:text-primary-foreground`}
      >
        {tech}
      </Badge>
    );
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 max-lg:grid-cols-1 items-center gap-2">
              ...
              <Button
                ...
                disabled={exam.solution_link === "" || exam.solution_link === null}
              >
              ...
              <Button
                ...
                disabled={exam.materials_link === "" || exam.materials_link === null}
              >
